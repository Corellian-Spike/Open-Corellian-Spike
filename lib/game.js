...
module.exports = class Game {
  ...
  scoreHands(players) {
    players = players ? players : [...this.table.players];
    ...
    for (let p = 0; p < players.length; p++) {
      ...
      if (p > 0) {
        if (winner.score.handRank > player.score.handRank) {
          ...
          if (winner.score.sabacc.lowestX) {
            if (winner.score.sabacc.lowestX > player.score.sabacc.lowestX) {
              winner = player;
            } else if (winner.score.sabacc.lowestX === player.score.sabacc.lowestX) {
              if (winner.score.sabacc.lowestY) {
                if (winner.score.sabacc.lowestY > player.score.sabacc.lowestY) {
                  winner = player;
                } else if (winner.score.sabacc.lowestY === player.score.sabacc.lowestY) {
