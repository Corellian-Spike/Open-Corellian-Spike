...
module.exports = class Game {
  ...
  initializePlayers(playerCount) {
    ...
    for (let playerNumber = 1; playerNumber <= playerCount; playerNumber++) {
      ...
      player.wagerAction.matchCurrentWager = this.matchCurrentWagerByPlayer.bind(this, player);
      player.wagerAction.matchAndRaiseCurrentWagerByCredits = this.matchAndRaiseCurrentWagerByPlayerAndCredits.bind(this, player);
